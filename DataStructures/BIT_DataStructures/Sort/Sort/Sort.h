...
void HeapSort(SORTDATA arr[], int size); // 堆排序
void BubbleSort(SORTDATA arr[], int size); // 冒泡排序
void QuickSort(SORTDATA arr[], int left, int right); // 快速排序
void MergeSort(SORTDATA arr[], int left, int right); // 归并排序
